...
function pattern()
{
	...
	this.calculate=function()
	{
		...
		else if(this[22])r+=((this[22]==this.color)?-1:1)*25;
		if(this[18])r+=((this[18]==this.color)?1:-1)*30;
		else if(this[27])r+=((this[27]==this.color)?-1:1)*25;
		if(this[81])r+=((this[81]==this.color)?1:-1)*30;
		else if(this[72])r+=((this[72]==this.color)?-1:1)*25;
		if(this[88]){r+=((this[88]==this.color)?1:-1)*30;}
		else if(this[77])r+=((this[77]==this.color)?-1:1)*25;
						...
						{							
							...
							{								
								if(!pattern[p+directions[d]]
									...
									&&p-directions[d]<89
									&&(p-directions[d])%10!=0
									&&(p-directions[d])!=9)pattern.divergence++;
							}
						}
						break;
					}
